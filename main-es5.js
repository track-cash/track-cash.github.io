(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [
                ...
                { path: 'home', loadChildren: function () { return __webpack_require__.e(/*! import() | home-home-module */ "home-home-module").then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/home/home.module.ts")).then(function (m) { return m.HomeModule; }); } },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CurrencySelectorComponent = CurrencySelectorComponent_1 = /** @class */ (function () {
                function CurrencySelectorComponent(currencyService) {
                    var _this = this;
                    ...
                    currencyService.options().subscribe(function (data) { return _this.filteredItems = data; });
                }
                CurrencySelectorComponent.prototype.ngOnInit = function () {
                };
                CurrencySelectorComponent.prototype.displaySelectCurrency = function () {
                    this.isSelectCurrency = true;
                };
                Object.defineProperty(CurrencySelectorComponent.prototype, "counterValue", {
                    get: function () {
                ...
                CurrencySelectorComponent.prototype.ngOnChanges = function (inputs) {
                ...
                CurrencySelectorComponent.prototype.registerOnTouched = function () { };
                CurrencySelectorComponent.prototype.select = function (currency) {
                    this.counterValue = currency;
                    this.isSelectCurrency = false;
                };
                CurrencySelectorComponent.prototype.validate = function (c) {
                    return this.validateFn(c);
                };
                CurrencySelectorComponent.prototype.filterItem = function (value) {
                    var _this = this;
                    if (!value)
                        this.filteredItems = this.currencyService.options().subscribe(function (data) { return _this.filteredItems = data; }); //when nothing has typed
                    this.currencyService.options().subscribe(function (data) { return _this.filteredItems = data.filter(function (item) { return item.text.toLowerCase().indexOf(value.toLowerCase()) > -1; }); });
                };
                return CurrencySelectorComponent;
            }());
            CurrencySelectorComponent.ctorParameters = function () { return [
            ...
            CurrencySelectorComponent = CurrencySelectorComponent_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
                    ...
                    providers: [
                        { provide: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NG_VALUE_ACCESSOR"], useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(function () { return CurrencySelectorComponent_1; }), multi: true },
                        { provide: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NG_VALIDATORS"], useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(function () { return CurrencySelectorComponent_1; }), multi: true }
                    ],
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var API_URL = 'https://thps6qlf34.execute-api.us-east-1.amazonaws.com/latest/';
            var CURRENCY = {
            ...
            var CurrencyService = /** @class */ (function () {
                ...
                CurrencyService.prototype.options = function () {
                    return this.http.get(API_URL + 'currency')
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (currencyList) {
                        var currencyMap = [];
                        currencyList && currencyList.forEach(function (currency) {
                            currencyMap.push({
                                key: currency.id,
                ...
                ;
                CurrencyService.prototype.name = function (code) {
                    return CURRENCY[code].name;
                };
                ;
                CurrencyService.prototype.symbol = function (code) {
                    return CURRENCY[code].symbol;
                };
                ;
                CurrencyService.prototype.minamount = function (code) {
                 ...
                 * @param {string} code
                 */
                CurrencyService.prototype.toInt = function (value, code) {
                 ...
                 * @param {bool} format
                 */
                CurrencyService.prototype.toFloat = function (value, code, format) {
                    if (format === void 0) { format = true; }
                    var exp = 2; //CURRENCY[code].exp;
                    var num = Number(value + "e-" + exp);
                    return format
                ...
                ;
                CurrencyService.prototype.convert = function (value, rate, from, to) {
            ...
            var WalletService = /** @class */ (function () {
                ...
                WalletService.prototype.getAll = function () {
                    return this.http.get(API_URL + 'wallet')
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (wallets) {
                        var walletMap = [];
                        wallets && wallets.forEach(function (user) {
                            walletMap.push({
                                id: user['id'],
                                name: user['name'],
                ...
                WalletService.prototype.create = function (wallet) {
                    return this.http.post(API_URL + 'wallet', wallet);
                };
                WalletService.prototype.mutateBalance = function (_a) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WelcomeComponent = /** @class */ (function () {
                function WelcomeComponent(wallet, 
                ...
                WelcomeComponent.prototype.ngOnInit = function () {
                    this.wallet.getAll().subscribe(function (data) { return console.log(data); });
                ...
                WelcomeComponent.prototype.next = function (step) {
                    this.step += 1;
                };
                WelcomeComponent.prototype.key = function (value) {
                    console.log(value);
                ...
                WelcomeComponent.prototype.onSubmit = function (_a) {
                    var _this = this;
                    ...
                    this.wallet.create(wallet).subscribe(function (data) {
                        _this.router.navigate(['/home/home/transactions']);
                    });
                };
